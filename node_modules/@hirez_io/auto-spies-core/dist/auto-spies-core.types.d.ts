...
export type CreateSyncAutoSpy<Method extends Func, LibSpecificFunctionSpy, LibSpecificFunctionSpyPlusCalledWith> = Method & LibSpecificFunctionSpy & LibSpecificFunctionSpyPlusCalledWith;
...
export type OnlyMethodKeysOf<T> = StringKeysForPropertyType<T, {
    (...args: any[]): any;
}>;
